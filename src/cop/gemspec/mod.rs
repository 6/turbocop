...
pub fn register_all(registry: &mut CopRegistry) {
    registry.register(Box::new(add_runtime_dependency::AddRuntimeDependency));
    registry.register(Box::new(attribute_assignment::AttributeAssignment));
    registry.register(Box::new(dependency_version::DependencyVersion));
    registry.register(Box::new(
        deprecated_attribute_assignment::DeprecatedAttributeAssignment,
    ));
    registry.register(Box::new(development_dependencies::DevelopmentDependencies));
    ...
    registry.register(Box::new(required_ruby_version::RequiredRubyVersion));
    registry.register(Box::new(
