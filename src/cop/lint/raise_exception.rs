...
impl Cop for RaiseException {
    ...
    fn check_node(
        ...
        vec![Diagnostic {
            ...
            message: "Use a subclass of `Exception` instead of raising `Exception` directly."
                .to_string(),
        }]
    }
}
...
mod tests {
    ...
    fn offense_fixture() {
        assert_cop_offenses_full(
            &RaiseException,
            include_bytes!("../../../testdata/cops/lint/raise_exception/offense.rb"),
        );
    }
    ...
    fn no_offense_fixture() {
        assert_cop_no_offenses_full(
            &RaiseException,
            include_bytes!("../../../testdata/cops/lint/raise_exception/no_offense.rb"),
        );
    }
}
