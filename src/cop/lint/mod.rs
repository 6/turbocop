...
pub fn register_all(registry: &mut CopRegistry) {
    ...
    registry.register(Box::new(ambiguous_block_association::AmbiguousBlockAssociation));
    ...
    registry.register(Box::new(duplicate_regexp_character_class_element::DuplicateRegexpCharacterClassElement));
    ...
    registry.register(Box::new(hash_new_with_keyword_arguments_as_default::HashNewWithKeywordArgumentsAsDefault));
    ...
    registry.register(Box::new(heredoc_method_call_position::HeredocMethodCallPosition));
    ...
    registry.register(Box::new(incompatible_io_select_with_fiber_scheduler::IncompatibleIoSelectWithFiberScheduler));
    ...
    registry.register(Box::new(it_without_arguments_in_block::ItWithoutArgumentsInBlock));
    registry.register(Box::new(lambda_without_literal_block::LambdaWithoutLiteralBlock));
    ...
    registry.register(Box::new(mixed_regexp_capture_types::MixedRegexpCaptureTypes));
    registry.register(Box::new(missing_cop_enable_directive::MissingCopEnableDirective));
    ...
    registry.register(Box::new(non_deterministic_require_order::NonDeterministicRequireOrder));
    ...
    registry.register(Box::new(numeric_operation_with_constant_result::NumericOperationWithConstantResult));
    ...
    registry.register(Box::new(parentheses_as_grouped_expression::ParenthesesAsGroupedExpression));
    ...
    registry.register(Box::new(redundant_cop_disable_directive::RedundantCopDisableDirective));
    registry.register(Box::new(redundant_cop_enable_directive::RedundantCopEnableDirective));
    registry.register(Box::new(redundant_dir_glob_sort::RedundantDirGlobSort));
    registry.register(Box::new(redundant_regexp_quantifiers::RedundantRegexpQuantifiers));
    ...
    registry.register(Box::new(require_relative_self_path::RequireRelativeSelfPath));
    ...
    registry.register(Box::new(safe_navigation_consistency::SafeNavigationConsistency));
    registry.register(Box::new(safe_navigation_with_empty::SafeNavigationWithEmpty));
    ...
    registry.register(Box::new(shadowing_outer_local_variable::ShadowingOuterLocalVariable));
    ...
    registry.register(Box::new(suppressed_exception_in_number_conversion::SuppressedExceptionInNumberConversion));
    ...
    registry.register(Box::new(underscore_prefixed_variable_name::UnderscorePrefixedVariableName));
    registry.register(Box::new(unescaped_bracket_in_regexp::UnescapedBracketInRegexp));
    ...
    registry.register(Box::new(unmodified_reduce_accumulator::UnmodifiedReduceAccumulator));
    ...
    registry.register(Box::new(useless_default_value_argument::UselessDefaultValueArgument));
