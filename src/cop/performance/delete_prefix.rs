...
impl Cop for DeletePrefix {
    ...
    fn check_node(
        ...
        vec![Diagnostic {
            ...
            message: "Use `delete_prefix` instead of `gsub`.".to_string(),
        }]
    }
}
...
mod tests {
    ...
    fn offense_fixture() {
        assert_cop_offenses_full(
            &DeletePrefix,
            include_bytes!("../../../testdata/cops/performance/delete_prefix/offense.rb"),
        );
    }
    ...
    fn no_offense_fixture() {
        assert_cop_no_offenses_full(
            &DeletePrefix,
            include_bytes!("../../../testdata/cops/performance/delete_prefix/no_offense.rb"),
        );
    }
}
