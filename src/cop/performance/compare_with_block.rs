...
impl Cop for CompareWithBlock {
    ...
    fn check_node(
        ...
        vec![Diagnostic {
            ...
            message: "Use `sort_by(&:method)` instead of `sort { |a, b| a.method <=> b.method }`.".to_string(),
        }]
    }
}
...
mod tests {
    ...
    fn offense_fixture() {
        assert_cop_offenses_full(
            &CompareWithBlock,
            include_bytes!("../../../testdata/cops/performance/compare_with_block/offense.rb"),
        );
    }
    ...
    fn no_offense_fixture() {
        assert_cop_no_offenses_full(
            &CompareWithBlock,
            include_bytes!("../../../testdata/cops/performance/compare_with_block/no_offense.rb"),
        );
    }
}
