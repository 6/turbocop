...
impl Cop for RedundantSortBlock {
    ...
    fn check_node(
        ...
        vec![Diagnostic {
            ...
            message: "Use `sort` instead of `sort { |a, b| a <=> b }`.".to_string(),
        }]
    }
}
...
mod tests {
    ...
    fn offense_fixture() {
        assert_cop_offenses_full(
            &RedundantSortBlock,
            include_bytes!(
                "../../../testdata/cops/performance/redundant_sort_block/offense.rb"
            ),
        );
    }
    ...
    fn no_offense_fixture() {
        assert_cop_no_offenses_full(
            &RedundantSortBlock,
            include_bytes!(
                "../../../testdata/cops/performance/redundant_sort_block/no_offense.rb"
            ),
        );
    }
}
