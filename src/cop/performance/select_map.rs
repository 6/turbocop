...
impl Cop for SelectMap {
    ...
    fn check_node(
        ...
        vec![Diagnostic {
            ...
            message: format!("Use `filter_map` instead of `{inner_name}...map`."),
        }]
    }
}
...
mod tests {
    ...
    fn offense_fixture() {
        assert_cop_offenses_full(
            &SelectMap,
            include_bytes!("../../../testdata/cops/performance/select_map/offense.rb"),
        );
    }
    ...
    fn no_offense_fixture() {
        assert_cop_no_offenses_full(
            &SelectMap,
            include_bytes!("../../../testdata/cops/performance/select_map/no_offense.rb"),
        );
    }
}
