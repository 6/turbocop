...
impl Cop for RedundantEqualityComparisonBlock {
    ...
    fn check_node(
        ...
        vec![Diagnostic {
            ...
            message: "Use `grep` or `===` comparison instead of block with `==`.".to_string(),
        }]
    }
}
...
mod tests {
    ...
    fn offense_fixture() {
        assert_cop_offenses_full(
            ...
            include_bytes!(
                "../../../testdata/cops/performance/redundant_equality_comparison_block/offense.rb"
            ),
        );
    }
    ...
    fn no_offense_fixture() {
        assert_cop_no_offenses_full(
            &RedundantEqualityComparisonBlock,
            include_bytes!(
                "../../../testdata/cops/performance/redundant_equality_comparison_block/no_offense.rb"
            ),
        );
    }
}
