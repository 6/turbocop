...
- `Arachni__arachni__c1710d6: ui/cli/output.rb:444  [Use 2 (not 4) spaces for indentation.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `Arachni__arachni__c1710d6: lib/arachni/element/base.rb:1  [Avoid trailing inline comments.]`
- `Arachni__arachni__c1710d6: lib/arachni/component/manager.rb:1  [Avoid trailing inline comments.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `Arachni__arachni__c1710d6: lib/arachni/component/manager.rb:318  [Use `alias unload delete` instead of `alias :unload :delete`.]`
...
- `Arachni__arachni__c1710d6: ui/cli/output.rb:336  [Use `alias debug debug_on` instead of `alias :debug :debug_on`.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `discourse__discourse__9c8f125: script/bulk_import/generic_bulk.rb:459  [Do not use `#to_datetime`.]`
...
- `rouge-ruby__rouge__1a40dda: spec/lexers/xojo_spec.rb:1  [Unnecessary utf-8 encoding comment.]`
- `rouge-ruby__rouge__1a40dda: lib/rouge/lexers/ttcn3.rb:1  [Unnecessary utf-8 encoding comment.]`
- `rouge-ruby__rouge__1a40dda: spec/lexers/clojure_spec.rb:1  [Unnecessary utf-8 encoding comment.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `CocoaPods__Xcodeproj__2cf6a22: spec/scheme_spec.rb:821  [Redundant line continuation.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `DataDog__dd-trace-rb__e3406de: lib/datadog/core/transport/response.rb:21  [Return `false` instead of `nil` in predicate methods.]`
...
- `voormedia__rails-erd__7c66258: lib/rails_erd/domain/attribute.rb:12  [Do not place comments on the same line as the `def` keyword.]`
...
- `honeybadger-io__honeybadger-ruby__841f7bb: vendor/cli/inifile.rb:344  [Use hash literal `{}` instead of `Hash.new`.]`
- ... and 5 more (see corpus-results.json for full list)
