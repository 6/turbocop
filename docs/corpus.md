...
| Matches (both agree) | 11,750,390 |
| FP (nitrocop extra) | 13,368 |
| FN (nitrocop missing) | 118,721 |
| Registered cops | 910 |
| Cops with exact match | 661 |
| Cops with divergence | 190 |
...
| Performance | 52 | 51 | 1 | 0 | 41,963 | 0 | 9 | 99.9% |
...
190 cops diverge from RuboCop on the corpus. 661 cops match RuboCop exactly. 59 cops have no corpus data.
...
| Performance/StringIdentifierArgument | 1,911 | 0 | 9 | 99.5% |
...
- `AlchemyCMS__alchemy_cms__4c2023f: spec/requests/alchemy/api/nodes_controller_spec.rb:150  [Use parentheses for method calls with arguments.]`
...
- `Arachni__arachni__c1710d6: lib/arachni/plugin/manager.rb:1  [Avoid trailing inline comments.]`
- `Arachni__arachni__c1710d6: lib/arachni/support/lookup.rb:1  [Avoid trailing inline comments.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `Arachni__arachni__c1710d6: lib/arachni/page/dom.rb:227  [Use `alias inspect to_s` instead of `alias :inspect :to_s`.]`
...
- `Netflix-Skunkworks__Scumblr__66ed69a: app/models/task.rb:237  [Use the return value of `if` expression for variable assignment and comparison.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `rouge-ruby__rouge__1a40dda: lib/rouge/lexers/mosel.rb:1  [Unnecessary utf-8 encoding comment.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `Arachni__arachni__c1710d6: spec/arachni/element/form_spec.rb:414  [Put one space between the method name and the first argument.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `CocoaPods__Xcodeproj__2cf6a22: spec/scheme_spec.rb:394  [Redundant line continuation.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `JEG2__highline__0321f84: examples/using_readline.rb:1  [Include a copyright notice matching /^Copyright (\(c\) )?2[0-9]{3} .+/ before any code.]`
...
- `ReactiveX__RxRuby__fb1c5cf: test/rx/core/test_observable_creation.rb:381  [Redundant `return` detected.]`
...
- `natalie-lang__natalie__b507cff: spec/core/kernel/format_spec.rb:13  [Use `"hello"` directly instead of `format`.]`
...
- `fluent__fluentd__1327bed: test/plugin_helper/test_server.rb:381  [Do not use semicolons to terminate expressions.]`
...
- `antiwork__gumroad__782a69f: app/mailers/customer_low_priority_mailer.rb:342  [Redundant safe navigation detected, use `.` instead.]`
...
- `voormedia__rails-erd__7c66258: lib/rails_erd/domain/relationship.rb:63  [Do not place comments on the same line as the `def` keyword.]`
...
<details>
<summary><strong>Performance/StringIdentifierArgument</strong> — 1,911 matches, 0 FP, 9 FN (99.5%)</summary>

**False negatives** (RuboCop reports, nitrocop does not):

- `fluent__fluentd__1327bed: lib/fluent/plugin/out_forward.rb:733  [Use `:"\x00"` instead of `"\0"`.]`
- `fluent__fluentd__1327bed: test/plugin/test_out_forward.rb:1129  [Use `:"\x00"` instead of `"\0"`.]`
- `midori-rb__midori.rb__a431868: spec/midori/fixtures/example_api.rb:74  [Use `:""` instead of `''`.]`
...
| fluent__fluentd__1327bed | 456 | 99.0% | 62,816 | 74 | 523 |
...
| midori-rb__midori.rb__a431868 | 44 | 99.1% | 1,160 | 2 | 8 |
...
| natalie-lang__natalie__b507cff | 3,587 | 99.2% | 213,608 | 136 | 1,504 |
