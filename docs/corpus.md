...
|--------|------:|
| Repos | 1017 |
| Repos with 100% match | 30 |
| Files inspected | 228,194 |
| Offenses compared | 11,882,187 |
| Matches (both agree) | 11,756,447 |
| FP (nitrocop extra) | 13,076 |
| FN (nitrocop missing) | 112,664 |
| Registered cops | 910 |
| Cops with exact match | 668 |
| Cops with divergence | 183 |
...
| Layout | 100 | 77 | 23 | 0 | 1,504,607 | 10,576 | 40,024 | 96.7% |
| Lint | 148 | 129 | 11 | 8 | 1,929,573 | 919 | 7,194 | 99.5% |
| Metrics | 10 | 10 | 0 | 0 | 256,581 | 0 | 0 | 100.0% |
| Migration | 1 | 1 | 0 | 0 | 105 | 0 | 0 | 100.0% |
| Naming | 19 | 18 | 1 | 0 | 94,934 | 0 | 2 | 99.9% |
| Performance | 52 | 51 | 1 | 0 | 41,970 | 0 | 2 | 99.9% |
| RSpec | 113 | 108 | 3 | 2 | 1,413,800 | 3 | 59 | 99.9% |
| RSpecRails | 8 | 7 | 0 | 1 | 22,842 | 0 | 0 | 100.0% |
| Rails | 138 | 90 | 4 | 44 | 176,332 | 33 | 2 | 99.9% |
| Security | 6 | 6 | 0 | 0 | 2,584 | 0 | 0 | 100.0% |
| Style | 287 | 143 | 140 | 4 | 6,202,025 | 1,545 | 65,381 | 98.9% |
...
183 cops diverge from RuboCop on the corpus. 668 cops match RuboCop exactly. 59 cops have no corpus data.
...
| Layout/ExtraSpacing | 13,232 | 118 | 71 | 98.5% |
...
| RSpec/LeakyLocalVariable | 1,739 | 0 | 59 | 96.7% |
...
| Rails/DuplicateScope | 39 | 21 | 2 | 62.9% |
...
| Style/IfWithSemicolon | 77 | 16 | 0 | 82.7% |
...
| Style/FrozenStringLiteralComment | 120,067 | 1 | 9 | 99.9% |
| Rails/ActionControllerFlashBeforeRender | 97 | 9 | 0 | 91.5% |
| Style/ClassCheck | 2,106 | 0 | 9 | 99.5% |
| Lint/RedundantSplatExpansion | 189 | 7 | 1 | 95.9% |
...
| Style/DoubleNegation | 697 | 6 | 0 | 99.1% |
...
| Lint/RedundantSafeNavigation | 223 | 2 | 1 | 98.6% |
...
| Style/TrailingCommaInArrayLiteral | 15,727 | 3 | 0 | 99.9% |
...
| Naming/VariableNumber | 15,246 | 0 | 2 | 99.9% |
| Performance/Size | 37 | 0 | 2 | 94.8% |
| RSpec/SubjectStub | 3,762 | 2 | 0 | 99.9% |
| Rails/DuplicateAssociation | 40 | 2 | 0 | 95.2% |
...
<details>
<summary><strong>Layout/ExtraSpacing</strong> — 13,232 matches, 118 FP, 71 FN (98.5%)</summary>
...
<details>
<summary><strong>RSpec/LeakyLocalVariable</strong> — 1,739 matches, 0 FP, 59 FN (96.7%)</summary>
...
<details>
<summary><strong>Style/DateTime</strong> — 2,955 matches, 53 FP, 0 FN (98.2%)</summary>
...
- `discourse__discourse__9c8f125: script/bulk_import/generic_bulk.rb:368  [Do not use `#to_datetime`.]`
...
<details>
<summary><strong>Layout/EmptyLineAfterGuardClause</strong> — 20,617 matches, 0 FP, 45 FN (99.7%)</summary>

**False negatives** (RuboCop reports, nitrocop does not):

- `Shopify__pitchfork__c95f7a6: lib/pitchfork/configurator.rb:255  [Add empty line after guard clause.]`
- `ankane__ruby-polars__f274df0: lib/polars/utils/construction/data_frame.rb:277  [Add empty line after guard clause.]`
- `autolab__Autolab__674efe9: lib/statistics.rb:8  [Add empty line after guard clause.]`
...
<details>
<summary><strong>Rails/DuplicateScope</strong> — 39 matches, 21 FP, 2 FN (62.9%)</summary>

**False positives** (nitrocop reports, RuboCop does not):

- `huacnlee__rails-settings-cached__5bac334: test/dummy/app/models/setting.rb:13  [Multiple scopes share this same expression.]`
- `huacnlee__rails-settings-cached__5bac334: test/dummy/app/models/setting.rb:20  [Multiple scopes share this same expression.]`
- `huacnlee__rails-settings-cached__5bac334: test/dummy/app/models/setting.rb:26  [Multiple scopes share this same expression.]`
...
<details>
<summary><strong>Style/IfWithSemicolon</strong> — 77 matches, 16 FP, 0 FN (82.7%)</summary>
...
<details>
<summary><strong>Style/FrozenStringLiteralComment</strong> — 120,067 matches, 1 FP, 9 FN (99.9%)</summary>
...
<details>
<summary><strong>Rails/ActionControllerFlashBeforeRender</strong> — 97 matches, 9 FP, 0 FN (91.5%)</summary>

**False positives** (nitrocop reports, RuboCop does not):

- `TracksApp__tracks__53cf4b4: app/controllers/data_controller.rb:62  [Use `flash.now` before `render`.]`
- `TracksApp__tracks__53cf4b4: app/controllers/data_controller.rb:71  [Use `flash.now` before `render`.]`
- `greasyfork-org__greasyfork__9f42777: app/controllers/scripts_controller.rb:467  [Use `flash.now` before `render`.]`
- ... and 6 more (see corpus-results.json for full list)
...
<details>
<summary><strong>Lint/RedundantSplatExpansion</strong> — 189 matches, 7 FP, 1 FN (95.9%)</summary>
...
<details>
<summary><strong>Style/DoubleNegation</strong> — 697 matches, 6 FP, 0 FN (99.1%)</summary>
...
<details>
<summary><strong>Lint/RedundantSafeNavigation</strong> — 223 matches, 2 FP, 1 FN (98.6%)</summary>
...
- `natalie-lang__natalie__b507cff: spec/language/fixtures/rescue_captures.rb:77  [Redundant safe navigation detected, use `.` instead.]`
...
<details>
<summary><strong>Style/TrailingCommaInArrayLiteral</strong> — 15,727 matches, 3 FP, 0 FN (99.9%)</summary>
...
<details>
<summary><strong>Naming/VariableNumber</strong> — 15,246 matches, 0 FP, 2 FN (99.9%)</summary>

**False negatives** (RuboCop reports, nitrocop does not):

- `que-rb__que__caa8b25: lib/que/job_methods.rb:61  [Use normalcase for variable numbers.]`
- `sporkrb__spork__224df49: lib/spork/test_framework/cucumber.rb:34  [Use normalcase for variable numbers.]`

</details>

<details>
<summary><strong>Performance/Size</strong> — 37 matches, 0 FP, 2 FN (94.8%)</summary>

**False negatives** (RuboCop reports, nitrocop does not):

- `natalie-lang__natalie__b507cff: spec/core/array/count_spec.rb:6  [Use `size` instead of `count`.]`
- `rubyworks__facets__12326d4: test/core/hash/test_count.rb:17  [Use `size` instead of `count`.]`
...
<details>
<summary><strong>Rails/DuplicateAssociation</strong> — 40 matches, 2 FP, 0 FN (95.2%)</summary>

**False positives** (nitrocop reports, RuboCop does not):

- `zdennis__activerecord-import__d3d3f8a: test/models/author.rb:5  [Association `composite_books` is defined multiple times. Don't repeat associations.]`
- `zdennis__activerecord-import__d3d3f8a: test/models/author.rb:7  [Association `composite_books` is defined multiple times. Don't repeat associations.]`
...
<details>
<summary><strong>Rails/Delegate</strong> — 7,144 matches, 1 FP, 0 FN (99.9%)</summary>

**False positives** (nitrocop reports, RuboCop does not):

- `thiagopradi__octopus__1c0abed: lib/octopus/migration.rb:129  [Use `delegate` to define delegations.]`
...
| greasyfork-org__greasyfork__9f42777 | 839 | 97.1% | 15,481 | 21 | 432 |
...
| rubyworks__facets__12326d4 | 1,409 | 97.3% | 35,478 | 60 | 924 |
...
| huacnlee__rails-settings-cached__5bac334 | 60 | 98.0% | 989 | 7 | 13 |
...
| sporkrb__spork__224df49 | 51 | 98.5% | 2,164 | 1 | 30 |
...
| TracksApp__tracks__53cf4b4 | 286 | 98.7% | 15,514 | 36 | 157 |
...
| publiclab__plots2__5e1d8c2 | 366 | 98.9% | 23,019 | 30 | 204 |
...
| rails__rails__d7c8ae6 | 3,439 | 99.1% | 310,906 | 217 | 2,451 |
...
| tryzealot__zealot__80029ea | 328 | 99.1% | 8,799 | 16 | 59 |
...
| que-rb__que__caa8b25 | 79 | 99.2% | 7,235 | 9 | 46 |
...
| hackclub__hcb__651ab54 | 2,264 | 99.3% | 54,234 | 36 | 328 |
...
| natalie-lang__natalie__b507cff | 3,587 | 99.3% | 213,892 | 124 | 1,220 |
...
| ruby-china__homeland__9f5dbde | 416 | 99.5% | 10,765 | 8 | 41 |
...
| thiagopradi__octopus__1c0abed | 112 | 99.6% | 5,294 | 1 | 19 |
...
<details>
<summary>Perfect cops (668 cops with 100% match rate)</summary>
