...
| Offenses compared | 11,882,512 |
| Matches (both agree) | 11,750,193 |
| FP (nitrocop extra) | 13,401 |
| FN (nitrocop missing) | 118,918 |
| Registered cops | 910 |
...
| Performance/StringIdentifierArgument | 1,714 | 0 | 206 | 89.2% |
...
| Gemspec/RequiredRubyVersion | 1,218 | 32 | 0 | 97.4% |
...
| Performance/SelectMap | 1,001 | 1 | 0 | 99.9% |
...
- `Arachni__arachni__c1710d6: lib/arachni/framework/parts/browser.rb:1  [Avoid trailing inline comments.]`
- `Arachni__arachni__c1710d6: lib/arachni/snapshot.rb:1  [Avoid trailing inline comments.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `Arachni__arachni__c1710d6: lib/arachni/report.rb:203  [Use `alias to_hash to_h` instead of `alias :to_hash :to_h`.]`
...
- `Arachni__arachni__c1710d6: lib/arachni/option_groups/audit.rb:249  [Use `alias element= element` instead of `alias :element= :element`.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `Arachni__arachni__c1710d6: spec/components/checks/active/xpath_injection_spec.rb:8  [Do not use space inside array brackets.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `DataDog__dd-trace-rb__e3406de: spec/datadog/profiling/collectors/thread_context_spec.rb:1560  [`it` is the default block parameter; consider another name.]`
...
- `DataDog__dd-trace-rb__e3406de: spec/datadog/profiling/collectors/thread_context_spec.rb:960  [`it` is the default block parameter; consider another name.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `rouge-ruby__rouge__1a40dda: spec/lexers/protobuf_spec.rb:1  [Unnecessary utf-8 encoding comment.]`
- `rouge-ruby__rouge__1a40dda: spec/lexers/csvs_spec.rb:1  [Unnecessary utf-8 encoding comment.]`
- `rouge-ruby__rouge__1a40dda: lib/rouge/lexers/varnish.rb:1  [Unnecessary utf-8 encoding comment.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `Arachni__arachni__c1710d6: spec/components/plugins/login_script_spec.rb:194  [Put one space between the method name and the first argument.]`
- `Arachni__arachni__c1710d6: spec/arachni/browser_cluster_spec.rb:504  [Put one space between the method name and the first argument.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `CocoaPods__Xcodeproj__2cf6a22: spec/scheme_spec.rb:717  [Redundant line continuation.]`
- ... and 97 more (see corpus-results.json for full list)
...
<details>
<summary><strong>Performance/StringIdentifierArgument</strong> — 1,714 matches, 0 FP, 206 FN (89.2%)</summary>

**False negatives** (RuboCop reports, nitrocop does not):

- `AndyObtiva__glimmer__90326e6: lib/glimmer/data_binding/observable_hashable.rb:63  [Use `:[]=` instead of `'[]='`.]`
- `AndyObtiva__glimmer__90326e6: lib/glimmer/data_binding/observable_hashable.rb:71  [Use `:[]=` instead of `'[]='`.]`
- `aanand__git-up__64de741: lib/git-up.rb:266  [Use `:"merge-base"` instead of `"merge-base"`.]`
- ... and 97 more (see corpus-results.json for full list)
...
- `chef__chef__e58e1a1: kitchen-tests/test/integration/end-to-end/chef_client_hab_ca_cert/windows_spec.rb:5  [Do not use local variables defined outside of examples inside of them.]`
...
<details>
<summary><strong>Gemspec/RequiredRubyVersion</strong> — 1,218 matches, 32 FP, 0 FN (97.4%)</summary>

**False positives** (nitrocop reports, RuboCop does not):

- `dependabot__dependabot-core__0ed9632: docker_compose/dependabot-docker_compose.gemspec:24  [`required_ruby_version` and `TargetRubyVersion` (4.0, which may be specified in .rubocop.yml) should be equal.]`
- `dependabot__dependabot-core__0ed9632: bazel/dependabot-bazel.gemspec:24  [`required_ruby_version` and `TargetRubyVersion` (4.0, which may be specified in .rubocop.yml) should be equal.]`
- `dependabot__dependabot-core__0ed9632: git_submodules/dependabot-git_submodules.gemspec:24  [`required_ruby_version` and `TargetRubyVersion` (4.0, which may be specified in .rubocop.yml) should be equal.]`
- ... and 29 more (see corpus-results.json for full list)
...
- `ruby-concurrency__concurrent-ruby__30dc89e: examples/benchmark_read_write_lock.rb:105  [Replace with `Integer#odd?`.]`
- ... and 2 more (see corpus-results.json for full list)
...
<details>
<summary><strong>Performance/SelectMap</strong> — 1,001 matches, 1 FP, 0 FN (99.9%)</summary>

**False positives** (nitrocop reports, RuboCop does not):

- `getsentry__sentry-ruby__faa2853: sentry-ruby/lib/sentry/rspec.rb:74  [Use `filter_map` instead of `select.map`.]`
...
| mojombo__god__92c06aa | 137 | 95.6% | 5,261 | 4 | 235 |
| camping__camping__f2479aa | 71 | 95.6% | 6,554 | 8 | 289 |
...
| awesome-print__awesome_print__8a7ff0a | 73 | 96.4% | 2,600 | 0 | 96 |
| ytti__oxidized__98dcf85 | 282 | 96.4% | 9,401 | 12 | 330 |
...
| hybridgroup__artoo__2f0446a | 96 | 96.9% | 2,612 | 0 | 82 |
...
| ging__social_stream__a77380f | 467 | 97.5% | 18,046 | 19 | 442 |
...
| sinatra__sinatra__9e5c4ec | 162 | 97.5% | 10,155 | 13 | 241 |
...
| aanand__git-up__64de741 | 6 | 97.9% | 290 | 1 | 5 |
...
| activemerchant__active_merchant__ca45b1b | 825 | 98.2% | 110,731 | 40 | 1,905 |
...
| laserlemon__figaro__a2d7dcb | 36 | 98.6% | 1,175 | 4 | 12 |
...
| eventmachine__eventmachine__e732041 | 132 | 98.7% | 10,797 | 12 | 126 |
...
| AndyObtiva__glimmer__90326e6 | 56 | 98.7% | 4,530 | 0 | 57 |
...
| rubymotion-community__BubbleWrap__afdc89e | 167 | 98.8% | 8,376 | 0 | 95 |
...
| cucumber__cucumber-ruby__613c675 | 379 | 99.0% | 7,245 | 3 | 67 |
| fluent__fluentd__1327bed | 456 | 99.0% | 62,808 | 74 | 531 |
...
| midori-rb__midori.rb__a431868 | 44 | 99.0% | 1,159 | 2 | 9 |
...
| inspec__inspec__965502e | 1,108 | 99.0% | 57,312 | 50 | 477 |
...
| backup__backup__86c9b07 | 205 | 99.1% | 26,058 | 44 | 187 |
...
| getsentry__sentry-ruby__faa2853 | 328 | 99.2% | 26,216 | 10 | 196 |
...
| pakyow__pakyow__aa3d80a | 1,291 | 99.2% | 73,009 | 17 | 526 |
...
| zipmark__rspec_api_documentation__0c9692a | 141 | 99.2% | 5,317 | 6 | 32 |
...
| rodjek__puppet-lint__9608bd0 | 104 | 99.3% | 6,984 | 13 | 30 |
...
| dependabot__dependabot-core__0ed9632 | 1,727 | 99.4% | 218,700 | 467 | 845 |
...
| amazing-print__amazing_print__1b687bf | 74 | 99.4% | 2,442 | 1 | 13 |
...
| freerange__mocha__50844e9 | 230 | 99.7% | 6,865 | 0 | 17 |
