...
- **96.9% conformance** against RuboCop across [**1,000 open-source repos**](docs/corpus.md)
...
96.9% of compared issue reports matched (11.6M of 12.0M). 364 of 910 cops matched exactly; 546 differed.

**[rubocop](https://github.com/rubocop/rubocop)** `1.84.2` (588 cops)

| Department | Cops | Matched exactly | Differed | Matched exactly % |
|------------|-----:|----------------:|---------:|------------------:|
| Layout | 100 | 21 | 79 | 21.0% |
| Lint | 148 | 64 | 84 | 43.2% |
