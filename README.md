...
- **98.8% conformance** against RuboCop across [**1,000 open-source repos**](docs/corpus.md)
...
Compared with RuboCop on [**1,000 open-source repos**](docs/corpus.md) (218k Ruby files).

98.8% of compared issue reports matched (11.1M of 11.2M). 693 of 910 cops matched exactly; 217 differed.
