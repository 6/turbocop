...
- **97.3% conformance** against RuboCop across [**970 open-source repos**](docs/corpus.md)
...
Compared with RuboCop on [**970 open-source repos**](docs/corpus.md) (220k Ruby files).

97.3% of compared issue reports matched (10.9M of 11.2M). 463 of 910 cops matched exactly; 446 differed; 1 had no corpus data.
