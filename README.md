...
- **97.3% conformance** against RuboCop across [**940 open-source repos**](docs/corpus.md)
...
Compared with RuboCop on [**940 open-source repos**](docs/corpus.md) (212k Ruby files).

97.3% of compared issue reports matched (10.7M of 11.0M). 467 of 910 cops matched exactly; 442 differed; 1 had no corpus data.
