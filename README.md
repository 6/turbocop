...
- **97.3% conformance** against RuboCop across [**976 open-source repos**](docs/corpus.md)
...
Compared with RuboCop on [**976 open-source repos**](docs/corpus.md) (225k Ruby files).

97.3% of compared issue reports matched (11.2M of 11.5M). 466 of 910 cops matched exactly; 444 differed.
