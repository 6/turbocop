...
- **97.0% conformance** against RuboCop across [**992 open-source repos**](docs/corpus.md)
...
Compared with RuboCop on [**992 open-source repos**](docs/corpus.md) (230k Ruby files).

97.0% of compared issue reports matched (11.6M of 12.0M). 373 of 910 cops matched exactly; 537 differed.

**[rubocop](https://github.com/rubocop/rubocop)** `1.84.2` (588 cops)

| Department | Cops | Matched exactly | Differed | Matched exactly % |
|------------|-----:|----------------:|---------:|------------------:|
| Layout | 100 | 23 | 77 | 23.0% |
| Lint | 148 | 64 | 84 | 43.2% |
